...
[source, bash]
----
oc create -f https://raw.githubusercontent.com/redhat-canada/istio-tutorial/master/recommendation/kubernetes/Deployment.yml

oc create -f https://raw.githubusercontent.com/redhat-canada/istio-tutorial/master/recommendation/kubernetes/Service.yml
----
...
[source, bash]
----
oc create -f https://raw.githubusercontent.com/redhat-canada/istio-tutorial/master/recommendation/kubernetes/Deployment-v2.yml
